...
public class TrainRobber {
	...
	public static double finalPosition(int length, int nCarriages, String[] offset,
			String[] period, int trainSpeed, int robberSpeed, int nBridges) throws InterruptedException {
		String of = offset[0];
