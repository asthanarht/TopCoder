public class Aircraft {
    ...
    /*
     * editorial solution
     * http://community.topcoder.com/tc?module=Static&d1=match_editorials
     * &d2=srm347
     * 
     * if (A == 0) return "NO"; since A==0 ==> B==0
     * 
     * if (B >= 0) return "NO"; since -b + sqrt(b*b - 4*a*c) < -b + sqrt(b*b) =
     * 0 only B<0 can have non-negative toor
     */
}
