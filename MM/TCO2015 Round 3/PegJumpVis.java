                        ...
                        if (tc.board[i][j]>='0' && tc.board[i][j]<='9') {
                           // peg color
                            ...
                            // safarisoul
								...
								g2.drawString("" + tc.board[i][j], 15 + j
										* cellSize + 4, 15 + i * cellSize + 11);
                    		// safarisoul
                        }
                    }
                }
...
public class PegJumpVis {
    ...
    public static void main(String[] args) {
        ...
        try {
			long start = System.currentTimeMillis(); // safarisoul
			int score = vis.runTest();
			long end = System.currentTimeMillis(); // safarisoul
			System.out.println("time = " + (end - start)); // safarisoul
